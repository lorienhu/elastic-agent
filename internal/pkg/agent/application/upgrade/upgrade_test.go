...
func (m *mockArtifactDownloader) downloadArtifact(ctx context.Context, agentArtifact artifact.Artifact, sourceURI string, upgradeDetails *details.Details, skipVerifyOverride, skipDefaultPgp bool, pgpBytes ...string) (_ string, err error) {
