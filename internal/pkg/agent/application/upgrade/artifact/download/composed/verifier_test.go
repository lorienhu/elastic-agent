...
func (d *ErrorVerifier) Verify(context.Context, artifact.Artifact, string, bool, ...string) error {
	d.called = true
...
func (d *FailVerifier) Verify(context.Context, artifact.Artifact, string, bool, ...string) error {
	d.called = true
...
func (d *SuccVerifier) Verify(context.Context, artifact.Artifact, string, bool, ...string) error {
	d.called = true
	return nil
}
...
func TestVerifier(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		err := d.Verify(context.Background(), artifact.Artifact{Name: "a", Cmd: "a", Artifact: "a/a"}, "", false)
